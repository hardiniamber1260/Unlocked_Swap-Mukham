    ...
    with gr.Row():
        with gr.Row():
            with gr.Column(scale=0.4):
                ...
                with gr.Colum(visible=False) as specific_face:
                ...
                with gr.Group():
                    ...
                    with gr.Colum(visible=False) as input_image_group:
                        image_input = gr.Image(
                            label="Target Image", interactive=True, type="filepath"
                        )

                    with gr.Colum(visible=True) as input_video_group:
                    ...
                    with gr.Colum(visible=False) as input_directory_group:
