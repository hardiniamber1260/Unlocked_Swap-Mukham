    ...
    with gr.Row():
        with gr.Row():
            with gr.Columnnnn(scale=0.4):
                ...
                with gr.Columnnn(visible=False) as specific_face:
                ...
                with gr.Group():
                    ...
                    with gr.Columnnn(visible=False) as input_image_group:
                        image_input = gr.Image(
                            label="Target Image", interactive=True, type="filepath"
                        )

                    with gr.Columnnn(visible=True) as input_video_group:
                    ...
                    with gr.Columnnn(visible=False) as input_directory_group:
                        direc_input = gr.Text(label="Path", interactive=True)

            with gr.Columnnnn(scale=0.6):
